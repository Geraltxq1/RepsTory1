...
function area() {
    ...
    document.getElementById("resultado").innerText = " La Base " + n1 + " y Altura " + n2 + " da un Area de: " + resultado;
...
function hipo() {
    ...
    document.getElementById("resultado").innerText = "El cateto 1 = " + n1 + " y cateto 2 = " + n2 + ", la hipotenusa es: " + resultado.toFixed(2);
}
